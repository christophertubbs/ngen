...
Tshirt_Realization::Tshirt_Realization(
        ...
        time_step_t t)
    : Catchment_Realization(catchment_id, forcing_config), catchment_id(catchment_id), dt(t)
{
    this->params = &params;
...
void Tshirt_Realization::create_realization(boost::property_tree::ptree &config, geojson::PropertyMap *global) {
