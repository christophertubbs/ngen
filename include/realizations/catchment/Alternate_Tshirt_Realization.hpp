#ifndef NGEN_ALTERNATE_TSHIRT_REALIZATION_HPP
#define NGEN_ALTERNATE_TSHIRT_REALIZATION_HPP
...
namespace realization {
    ...
    class Alternate_Tshirt_Realization : public HY_CatchmentArea {

    public:

        typedef long time_step_t;

        Alternate_Tshirt_Realization(forcing_params forcing_config,
        ...
        virtual ~Alternate_Tshirt_Realization();
...
#endif //NGEN_ALTERNATE_TSHIRT_REALIZATION_HPP
