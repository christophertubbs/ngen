...
namespace realization {
    ...
    class Formulation_Manager {
            ...
            virtual void read(geojson::GeoJSON fabric, utils::StreamHandler output_stream) {
                ...
                for (geojson::Feature location : *fabric) {
                    if (not this->contains(location->get_id())) {
                        std::shared_ptr<Catchment_Formulation> missing_formulation = this->construct_missing_formulation(location->get_id(), output_stream);
        ...
        protected:
            ...
            std::shared_ptr<Catchment_Formulation> construct_missing_formulation(std::string identifier, utils::StreamHandler output_stream) {
