...
namespace realization {
    ...
    class Tshirt_Realization : public Catchment_Realization {
        ...
        public:
            ...
            std::string get_realization_type() {
                return "tshirt";
            }

            void create_realization(boost::property_tree::ptree &config, geojson::PropertyMap *global = nullptr);
